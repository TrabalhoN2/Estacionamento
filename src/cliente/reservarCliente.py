...
# Form implementation generated from reading ui file './docs/cliente/reservar_cliente.ui'
#
...
"text-align:center;")
    ...
    def retranslateUi(self, ReservarVaga):
        ...
        self.numeroVaga.setPlaceholderText(_translate("ReservarVaga", "Número da vaga"))
        ...
        self.nomeCliente.setPlaceholderText(_translate("ReservarVaga", "Nome"))
        self.placa.setPlaceholderText(_translate("ReservarVaga", "Placa do veículo"))
...
if __name__ == "__main__":
    ...
    ReservarVaga = QtWidgets.QMainWindow()
    ui = Ui_ReservarVaga()
    ui.setupUi(ReservarVaga)
    ReservarVaga.show()
    sys.exit(app.exec_())
