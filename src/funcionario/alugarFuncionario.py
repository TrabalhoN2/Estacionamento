...
# Form implementation generated from reading ui file './docs/funcionario/alugar_funcionario.ui'
#
...
"color: rgb(75, 74, 74);")
    ...
    def retranslateUi(self, AlugarVaga):
        ...
        self.numeroVaga.setPlaceholderText(_translate("AlugarVaga", "Vaga"))
        ...
        self.nomeCliente.setPlaceholderText(_translate("AlugarVaga", "Nome do cliente"))
        self.placa.setPlaceholderText(_translate("AlugarVaga", "Placa"))
